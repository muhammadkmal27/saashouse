  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-[3rem] p-12 text-center shadow-2xl shadow-slate-200 border border-slate-100 animate-in zoom-in-95 duration-500">
        ...
        <h1 className="text-3xl font-black text-slate-900 mb-4 tracking-tight">Payment Received!</h1>
        <p className="text-slate-500 font-medium mb-12 leading-relaxed">
            Thank you! Your subscription has been successfully activated. Your systems are now being automated.
        </p>
