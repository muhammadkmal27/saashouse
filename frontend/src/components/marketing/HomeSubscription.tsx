      ...
      <section className="relative px-6 pt-32 pb-20 text-center overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-[1.1] text-white">
            <T 
              en={<>Build your dream website<br/><span className="whitespace-nowrap">for only <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-cyan-400 text-transparent bg-clip-text">RM550</span></span></>} 
              bm={<>Bina Website impian anda<br/><span className="whitespace-nowrap">serendah <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-cyan-400 text-transparent bg-clip-text">RM550</span></span></>} 
            />
          </h1>
